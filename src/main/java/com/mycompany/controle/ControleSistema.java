...
public class ControleSistema {
    ...
    public static void cadastrar(){
       int optionProduto = VisaoMenu.menuEscolhaProduto();
    
       if(optionProduto == Constantes.CATEGORIA_VIDEO_GAME){
          produtos.add(VisaoVideoGame.telaCadastroVideoGame());
       
     
          
       }else if(optionProduto == Constantes.CATEGORIA_COMPUTADOR){
       ...
       if(object instanceof VideoGame){
        VideoGame videoGame = new VideoGame();
         ...
         System.out.println("Alterando o produto " + videoGame.toString());
           ...
           videoGame = (VideoGame) VisaoMenu.menuAlteracaoProdutoInformarcoes(videoGame);
           ...
           System.out.println("alterando  o produto" + computador.toString());
            ...
            computador = (Computador)VisaoMenu.menuAlteracaoProdutoInformarcoes(computador);
